...
header("Access-Control-Allow-Origin: *");
  ...
  if($numRow){
    ...
    $webhookUrl = "https://3dcart.plugins.safe.shop/webhook.php?t=".$tokenKey;
...
mail('ankit@geeksperhour.com', 'frontscript response',print_r($response,true));
            ...
            foreach ($response as $status) {
              if($status['Status'] == "200" || $status['Status'] == "201"){
                ...
                echo "<div class='alert alert-danger'>Widget is already installed or there is some error in adding widget to the site.</div>";
              }
            }
  }//end numrows
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#submitInfo').click(function(){
      ...
      $.ajax({
        type:'post',
        url:'https://3dcart.plugins.safe.shop/ajax.php',
    ...
    $('#webhook').click(function(){
      ...
      $.ajax({
        type:'post',
        url:'https://3dcart.plugins.safe.shop/webhook_check.php',
